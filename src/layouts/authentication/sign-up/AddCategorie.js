...
function AddCategorie() {
  ...
  const handleAjouterCategorie = async () => {
    try {
      ...
      const response = await fetch("https://0801241705-production.up.railway.app/categorie", {
        method: "POST",
        headers: {
      ...
      <Card>
        ...
        <ArgonBox pt={2} pb={3} px={3}>
          <ArgonBox component="form" role="form">
            ...
            <ArgonBox mt={4} mb={1}>
              <ArgonButton variant="gradient" color="dark" fullWidth onClick={handleAjouterCategorie}>
                Ajouter
              </ArgonButton>
            </ArgonBox>
          </ArgonBox>
